...
public class TestHeap {
    ...
    private static boolean testAdd(List<ElementType> data, List<ElementType> sortedData) {
    ...
    private static <E> boolean testAddConstruct(List<ElementType> data, List<ElementType> sortedData) {
        MyHeapPQ<ElementType> pq = new MyHeapPQ<>(data);
        boolean valid = true;
        ...
        if (valid) {
            System.out.println(" add passed Construct");
        }
        return valid;
    }
    ...
    public static void main(String[] args) {
        ...
        testAdd(data, sorted_data);
        System.exit(testAddConstruct(data, sorted_data) ? 0 : 1);
